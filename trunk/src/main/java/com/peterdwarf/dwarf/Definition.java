...
public class Definition {
	...
	public static int DW_OP_addr = 0x03;
	public static int DW_OP_deref = 0x06;
	public static int DW_OP_const1u = 0x08;
	public static int DW_OP_const1s = 0x09;
	public static int DW_OP_const2u = 0x0a;
	public static int DW_OP_const2s = 0x0b;
	public static int DW_OP_const4u = 0x0c;
	public static int DW_OP_const4s = 0x0d;
	public static int DW_OP_const8u = 0x0e;
	public static int DW_OP_const8s = 0x0f;
	public static int DW_OP_constu = 0x10;
	public static int DW_OP_consts = 0x11;
	public static int DW_OP_dup = 0x12;
	public static int DW_OP_drop = 0x13;
	public static int DW_OP_over = 0x14;
	public static int DW_OP_pick = 0x15;
	public static int DW_OP_swap = 0x16;
	public static int DW_OP_rot = 0x17;
	public static int DW_OP_xderef = 0x18;
	public static int DW_OP_abs = 0x19;
	public static int DW_OP_and = 0x1a;
	public static int DW_OP_div = 0x1b;
	public static int DW_OP_minus = 0x1c;
	public static int DW_OP_mod = 0x1d;
	public static int DW_OP_mul = 0x1e;
	public static int DW_OP_neg = 0x1f;
	public static int DW_OP_not = 0x20;
	public static int DW_OP_or = 0x21;
	public static int DW_OP_plus = 0x22;
	public static int DW_OP_plus_uconst = 0x23;
	public static int DW_OP_shl = 0x24;
	public static int DW_OP_shr = 0x25;
	public static int DW_OP_shra = 0x26;
	public static int DW_OP_xor = 0x27;
	public static int DW_OP_bra = 0x28;
	public static int DW_OP_eq = 0x29;
	public static int DW_OP_ge = 0x2a;
	public static int DW_OP_gt = 0x2b;
	public static int DW_OP_le = 0x2c;
	public static int DW_OP_lt = 0x2d;
	public static int DW_OP_ne = 0x2e;
	public static int DW_OP_skip = 0x2f;
	public static int DW_OP_lit0 = 0x30;
	public static int DW_OP_lit1 = 0x31;
	public static int DW_OP_lit2 = 0x32;
	public static int DW_OP_lit3 = 0x33;
	public static int DW_OP_lit4 = 0x34;
	public static int DW_OP_lit5 = 0x35;
	public static int DW_OP_lit6 = 0x36;
	public static int DW_OP_lit7 = 0x37;
	public static int DW_OP_lit8 = 0x38;
	public static int DW_OP_lit9 = 0x39;
	public static int DW_OP_lit10 = 0x3a;
	public static int DW_OP_lit11 = 0x3b;
	public static int DW_OP_lit12 = 0x3c;
	public static int DW_OP_lit13 = 0x3d;
	public static int DW_OP_lit14 = 0x3e;
	public static int DW_OP_lit15 = 0x3f;
	public static int DW_OP_lit16 = 0x40;
	public static int DW_OP_lit17 = 0x41;
	public static int DW_OP_lit18 = 0x42;
	public static int DW_OP_lit19 = 0x43;
	public static int DW_OP_lit20 = 0x44;
	public static int DW_OP_lit21 = 0x45;
	public static int DW_OP_lit22 = 0x46;
	public static int DW_OP_lit23 = 0x47;
	public static int DW_OP_lit24 = 0x48;
	public static int DW_OP_lit25 = 0x49;
	public static int DW_OP_lit26 = 0x4a;
	public static int DW_OP_lit27 = 0x4b;
	public static int DW_OP_lit28 = 0x4c;
	public static int DW_OP_lit29 = 0x4d;
	public static int DW_OP_lit30 = 0x4e;
	public static int DW_OP_lit31 = 0x4f;
	public static int DW_OP_reg0 = 0x50;
	public static int DW_OP_reg1 = 0x51;
	public static int DW_OP_reg2 = 0x52;
	public static int DW_OP_reg3 = 0x53;
	public static int DW_OP_reg4 = 0x54;
	public static int DW_OP_reg5 = 0x55;
	public static int DW_OP_reg6 = 0x56;
	public static int DW_OP_reg7 = 0x57;
	public static int DW_OP_reg8 = 0x58;
	public static int DW_OP_reg9 = 0x59;
	public static int DW_OP_reg10 = 0x5a;
	public static int DW_OP_reg11 = 0x5b;
	public static int DW_OP_reg12 = 0x5c;
	public static int DW_OP_reg13 = 0x5d;
	public static int DW_OP_reg14 = 0x5e;
	public static int DW_OP_reg15 = 0x5f;
	public static int DW_OP_reg16 = 0x60;
	public static int DW_OP_reg17 = 0x61;
	public static int DW_OP_reg18 = 0x62;
	public static int DW_OP_reg19 = 0x63;
	public static int DW_OP_reg20 = 0x64;
	public static int DW_OP_reg21 = 0x65;
	public static int DW_OP_reg22 = 0x66;
	public static int DW_OP_reg23 = 0x67;
	public static int DW_OP_reg24 = 0x68;
	public static int DW_OP_reg25 = 0x69;
	public static int DW_OP_reg26 = 0x6a;
	public static int DW_OP_reg27 = 0x6b;
	public static int DW_OP_reg28 = 0x6c;
	public static int DW_OP_reg29 = 0x6d;
	public static int DW_OP_reg30 = 0x6e;
	public static int DW_OP_reg31 = 0x6f;
	public static int DW_OP_breg0 = 0x70;
	public static int DW_OP_breg1 = 0x71;
	public static int DW_OP_breg2 = 0x72;
	public static int DW_OP_breg3 = 0x73;
	public static int DW_OP_breg4 = 0x74;
	public static int DW_OP_breg5 = 0x75;
	public static int DW_OP_breg6 = 0x76;
	public static int DW_OP_breg7 = 0x77;
	public static int DW_OP_breg8 = 0x78;
	public static int DW_OP_breg9 = 0x79;
	public static int DW_OP_breg10 = 0x7a;
	public static int DW_OP_breg11 = 0x7b;
	public static int DW_OP_breg12 = 0x7c;
	public static int DW_OP_breg13 = 0x7d;
	public static int DW_OP_breg14 = 0x7e;
	public static int DW_OP_breg15 = 0x7f;
	public static int DW_OP_breg16 = 0x80;
	public static int DW_OP_breg17 = 0x81;
	public static int DW_OP_breg18 = 0x82;
	public static int DW_OP_breg19 = 0x83;
	public static int DW_OP_breg20 = 0x84;
	public static int DW_OP_breg21 = 0x85;
	public static int DW_OP_breg22 = 0x86;
	public static int DW_OP_breg23 = 0x87;
	public static int DW_OP_breg24 = 0x88;
	public static int DW_OP_breg25 = 0x89;
	public static int DW_OP_breg26 = 0x8a;
	public static int DW_OP_breg27 = 0x8b;
	public static int DW_OP_breg28 = 0x8c;
	public static int DW_OP_breg29 = 0x8d;
	public static int DW_OP_breg30 = 0x8e;
	public static int DW_OP_breg31 = 0x8f;
	public static int DW_OP_regx = 0x90;
	public static int DW_OP_fbreg = 0x91;
	public static int DW_OP_bregx = 0x92;
	public static int DW_OP_piece = 0x93;
	public static int DW_OP_deref_size = 0x94;
	public static int DW_OP_xderef_size = 0x95;
	public static int DW_OP_nop = 0x96;
	public static int DW_OP_push_object_address = 0x97; /* DWARF3 */
	public static int DW_OP_call2 = 0x98; /* DWARF3 */
	public static int DW_OP_call4 = 0x99; /* DWARF3 */
	public static int DW_OP_call_ref = 0x9a; /* DWARF3 */
	public static int DW_OP_form_tls_address = 0x9b; /* DWARF3f */
	public static int DW_OP_call_frame_cfa = 0x9c; /* DWARF3f */
	public static int DW_OP_bit_piece = 0x9d; /* DWARF3f */
	public static int DW_OP_implicit_value = 0x9e; /* DWARF4 */
	public static int DW_OP_stack_value = 0x9f; /* DWARF4 */
	public static int DW_OP_implicit_pointer = 0xa0; /* DWARF5 */
	public static int DW_OP_addrx = 0xa1; /* DWARF5 */
	public static int DW_OP_constx = 0xa2; /* DWARF5 */

	/* GNU extensions. */
	public static int DW_OP_GNU_push_tls_address = 0xe0; /* GNU */

	/* Follows extension so dwarfdump prints the most-likely-useful name. */
	public static int DW_OP_lo_user = 0xe0;

	public static int DW_OP_GNU_uninit = 0xf0; /* GNU */
	public static int DW_OP_GNU_encoded_addr = 0xf1; /* GNU */
	public static int DW_OP_GNU_implicit_pointer = 0xf2; /* GNU */
	public static int DW_OP_GNU_entry_value = 0xf3; /* GNU */
	public static int DW_OP_GNU_const_type = 0xf4; /* GNU */
	public static int DW_OP_GNU_regval_type = 0xf5; /* GNU */
	public static int DW_OP_GNU_deref_type = 0xf6; /* GNU */
	public static int DW_OP_GNU_convert = 0xf7; /* GNU */
	public static int DW_OP_GNU_reinterpret = 0xf9; /* GNU */
	public static int DW_OP_GNU_parameter_ref = 0xfa; /* GNU */
	public static int DW_OP_GNU_addr_index = 0xfb; /* GNU DebugFission */
	public static int DW_OP_GNU_const_index = 0xfc; /* GNU DebugFission */

	/* HP extensions. */
	public static int DW_OP_HP_unknown = 0xe0; /* HP conflict: GNU */
	public static int DW_OP_HP_is_value = 0xe1; /* HP */
	public static int DW_OP_HP_fltconst4 = 0xe2; /* HP */
	public static int DW_OP_HP_fltconst8 = 0xe3; /* HP */
	public static int DW_OP_HP_mod_range = 0xe4; /* HP */
	public static int DW_OP_HP_unmod_range = 0xe5; /* HP */
	public static int DW_OP_HP_tls = 0xe6; /* HP */

	public static int DW_OP_INTEL_bit_piece = 0xe8; /* Intel: made obsolete by DW_OP_bit_piece above. */

	/* Apple extension. */
	public static int DW_OP_APPLE_uninit = 0xf0; /* Apple */
	public static int DW_OP_PGI_omp_thread_num = 0xf8; /* PGI (STMicroelectronics) */

	public static int DW_OP_hi_user = 0xff;
}
